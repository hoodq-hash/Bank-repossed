...
const testimonials = [
  ...
  },
  {
    ...
    content:
      "I recently purchased a 2021 BMW 3 Series through Bank Repossessed Cars. The inspection report was incredibly comprehensive and when I visited to see the car, everything matched exactly what was documented. Their staff were knowledgeable and helped negotiate a fair price. The international shipping process was handled seamlessly. I would absolutely recommend Bank Repossessed Cars to anyone looking for quality vehicles worldwide.",
    date: "28 Feb, 2025",
  ...
  },
  {
    ...
    content:
      "After my local dealerships disappointed me with their limited inventory, I found exactly what I was looking for at Bank Repossessed Cars. Their online platform made browsing easy, and their team was incredibly responsive to my questions. The Jeep Wrangler I purchased was in immaculate condition and priced fairly. The paperwork was handled efficiently, and they even helped arrange delivery to my home in Chicago.",
    date: "5 Feb, 2025",
  ...
  },
  {
    ...
    content:
      "As someone who dreads car shopping, Bank Repossessed Cars made the experience surprisingly pleasant. Their no-pressure approach and transparent pricing were refreshing. They found me a certified pre-owned Volvo XC60 that met all my requirements and arranged for delivery to Manchester without any hassle. Their attention to detail in the inspection report gave me complete peace of mind with my purchase.",
    date: "20 Jan, 2025",
  ...
  },
  {
    ...
    content:
      "I was initially hesitant about purchasing a vehicle from a dealer I hadn't visited in person, but Bank Repossessed Cars quickly earned my trust. Their video walkaround of the Range Rover I was interested in was comprehensive, and they were completely transparent about its history and condition. The import process to Scotland was handled seamlessly, and the vehicle arrived exactly as described. I couldn't be happier with my experience.",
    date: "15 Nov, 2024",
  ...
  },
  {
    ...
    content:
      "Bank Repossessed Cars helped me find a Honda CR-V with all the features I wanted at a price well below what local dealerships were offering. Their team was patient as I compared different options, and they provided detailed information about each vehicle's history and condition. The purchase process was straightforward, and they handled all the paperwork efficiently. The vehicle has performed flawlessly since I received it.",
    date: "3 Oct, 2024",
  ...
  },
  {
    ...
    content:
      "Importing a vehicle to Canada can be complicated, but Bank Repossessed Cars made it straightforward. They were knowledgeable about Canadian regulations and handled all the necessary documentation. The Ford Explorer I purchased was thoroughly inspected and arrived in excellent condition. Their after-sales support has been exceptional, even helping me find a local service center for routine maintenance.",
    date: "10 Jul, 2024",
  ...
  },
  {
    ...
    content:
      "Bank Repossessed Cars offered me access to vehicles I simply couldn't find locally. Their online platform was easy to navigate and allowed me to compare multiple options. When I had questions about specific features, their team provided detailed answers and even sent additional photos and videos. The Subaru Outback I purchased arrived in perfect condition and exactly as described. The entire experience was professional from start to finish.",
    date: "5 Jun, 2024",
  ...
  },
  {
    ...
    content:
      "Bank Repossessed Cars took all the stress out of buying a car from overseas. Their detailed inspection reports and transparent pricing gave me confidence in my purchase decision. They guided me through the entire import process, handling all the documentation and ensuring my Lexus RX met UK standards. Their customer service was exceptional, with prompt responses to all my queries despite the time difference.",
    date: "12 May, 2024",
  ...
  },
  {
    ...
    content:
      "After searching local dealerships for months, I found my dream car through Bank Repossessed Cars. Their inventory was impressive and their online platform made it easy to find exactly what I wanted. The Audi Q7 I purchased was meticulously inspected and in better condition than advertised. Their team was professional throughout the process and handled all the paperwork efficiently. I couldn't be happier with my experience.",
    date: "28 Apr, 2024",
  ...
  },
  {
    ...
    content:
      "Bank Repossessed Cars provided an exceptional car buying experience from start to finish. Their inspection process is incredibly thorough, and they were completely transparent about the vehicle's history and condition. They handled all the import paperwork for my Volkswagen GTI and even arranged for winter tires to be installed before delivery. Their attention to detail and customer service is unmatched in the industry.",
    date: "15 Apr, 2024",
  ...
  },
  {
    ...
    content:
      "What sets Bank Repossessed Cars apart is their transparency and honesty. When the initial inspection of my chosen vehicle revealed some minor issues, they immediately informed me and offered solutions. They repaired everything before shipping and provided detailed documentation of the work done. The Toyota 4Runner arrived in excellent condition, and their follow-up service has been equally impressive.",
    date: "20 Mar, 2024",
  ...
  },
  {
    ...
    title: "Simplified the import process",
    content:
      "Bank Repossessed Cars made importing a vehicle to Canada incredibly straightforward. Their knowledge of Canadian regulations saved me from potential headaches, and they handled all the necessary paperwork. The Honda Pilot I purchased was thoroughly inspected and arrived in excellent condition. Their customer service was outstanding throughout the process, and I've already recommended them to several colleagues.",
    date: "15 Dec, 2023",
    ...
    <section className="py-16 md:py-24 bg-gray-50 border-t border-gray-200 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="relative">
                ...
                <div key={index} className="w-full flex-shrink-0 px-4">
                  <div className="bg-white border border-gray-200 shadow-lg p-8 md:p-10 max-w-4xl mx-auto">
                    ...
                    <div className="relative mb-8">
                      <div className="absolute -top-4 -left-4 text-6xl text-emerald-200 opacity-50">
                        "
                      </div>
                      <p className="text-gray-600 text-sm relative z-10 pl-6">
                        {testimonial.content}
                      </p>
                      <div className="absolute -bottom-8 -right-4 text-6xl text-emerald-200 opacity-50 transform rotate-180">
                        "
                      </div>
                    </div>
          ...
          <button
            onClick={prevSlide}
            className="absolute top-1/2 left-0 transform -translate-y-1/2 -translate-x-1/2 md:-translate-x-0 bg-white w-10 h-10 md:w-12 md:h-12 rounded-full shadow-lg flex items-center justify-center text-gray-800 hover:text-emerald-600 focus:outline-none z-10"
          ...
          <button
            onClick={nextSlide}
            className="absolute top-1/2 right-0 transform -translate-y-1/2 translate-x-1/2 md:translate-x-0 bg-white w-10 h-10 md:w-12 md:h-12 rounded-full shadow-lg flex items-center justify-center text-gray-800 hover:text-emerald-600 focus:outline-none z-10"
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`w-3 h-3 mx-1 rounded-full ${
                  activeSlide === index ? "bg-emerald-600" : "bg-gray-300"
                }`}
